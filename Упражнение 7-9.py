...
def main():
    ...
    try:
        ...
        input_file = open(r'USPopulation.txt', 'r')
        ...
        print('Среднегодовое изменение в численности '
              'во время этого периода времени составило', format(average_change, ',.2f').replace(',', ' '))
        print('Год с максимальным ростом численности', BASE_YEAR + greatest_year)
        print('Год с минимальным ростом численности', BASE_YEAR + smallest_year)
